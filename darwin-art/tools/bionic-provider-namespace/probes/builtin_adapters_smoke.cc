...
int main() {
  ...
  constexpr size_t kExpectedCalls[] = {11, 4,  1,  29, 3, 24, 3, 1, 13,
                                       31, 6,  2,  3,  1,  4, 2, 18, 2};
  ...
  std::fprintf(stderr, "bionic-provider-builtin-adapters: PASS providers=18 "
                       "routes=158 libdl-soname=exact\n");
  return 0;
}
