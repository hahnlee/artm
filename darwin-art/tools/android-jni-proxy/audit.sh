...
echo 'android-jni-proxy: PASS Android16 slots=233+8 subset=20 strings+refs+byte-array+exceptions=current-env-forwarded ELF=AArch64 proxy-only E2E ASAN+UBSAN'
