...
for definition in '__NR_futex 98' '__NR_rt_sigprocmask 135' '__NR_gettid 178'; do
...
clean
echo 'bionic-syscall-facade: PASS import=1 callsites=9 nr=98+135+178 AAPCS64=captured gettid=stable futex=private-side-table+monotonic-timeout+capacity257 readability=mach-vm errno=Bionic host-syscall=0 ASan+UBSan'
