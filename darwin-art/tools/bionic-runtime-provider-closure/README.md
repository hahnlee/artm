...
The current closure contains nineteen providers and resolves 160 exact routes:
142 of the pinned Android 35 arm64 `libc++_shared.so` libc-family imports plus
all 18 public `liblog.so` exports. The remaining 18 libc imports stay explicit
